...
void vtkSlicerMarkupsWidgetRepresentation::BuildLine(vtkPolyData* linePolyData, bool displayPosition)
{
  ...
  vtkMRMLMarkupsNode* markupsNode = this->GetMarkupsNode();
  cout << "BuildLine: begin function  " << endl;
  cout << "BuildLine: markupsNode  " << markupsNode->GetID() << endl;

    if (!markupsNode)
    {
    cout << "BuildLine: markupsNode =  " << markupsNode << endl;
  ...
  cout << "BuildLine: numberOfControlPoints =   " << numberOfLines << endl;
  cout << "BuildLine: loop = " << loop << endl;
  ...
  cout << "BuildLine: points = " << points << endl;
  cout << "BuildLine: line = " << line << endl;
  linePolyData->SetPoints(points);
  linePolyData->SetLines(line);
}
...
void vtkSlicerMarkupsWidgetRepresentation::DeleteMarkupsDisplayNode() {
    this->MarkupsDisplayNode = nullptr;
}
