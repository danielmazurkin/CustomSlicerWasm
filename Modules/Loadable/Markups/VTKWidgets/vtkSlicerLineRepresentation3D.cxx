...
vtkSlicerLineRepresentation3D::vtkSlicerLineRepresentation3D()
{
    ...
    // Mappers
    this->LineMapper = vtkSmartPointer<vtkOpenGLES30PolyDataMapper>::New();
    this->LineMapper->SetInputConnection(this->TubeFilter->GetOutputPort());

    this->LineOccludedMapper = vtkSmartPointer<vtkOpenGLES30PolyDataMapper>::New();
...
int vtkSlicerLineRepresentation3D::RenderOverlay(vtkViewport *viewport)
{
    ...
    cout << "vtkSlicerLineRepresentation3D::RenderOverlay(): " << this->Superclass::RenderOverlay(viewport) << endl;
    ...
    cout << "vtkSlicerLineRepresentation3D::RenderOverlay(): count " << count << endl;
...
void vtkSlicerLineRepresentation3D::UpdateFromMRML(vtkMRMLNode* caller, unsigned long event, void *callData /*=nullptr*/)
{
    ...
    cout << "UpdateFromMRML(): markupsNode: " << markupsNode << endl;
    ...
    cout << "UpdateFROMMRML: markupsNode  BUILD " << endl;
    // Line display
