...
vtkMRMLDisplayableNode* vtkMRMLDisplayNode::GetDisplayableNode()
{
  ...
  int collectionSize = sceneNodes->GetNumberOfItems();

//  vtkMRMLNode* node_test  = vtkMRMLNode::SafeDownCast(sceneNodes->GetNextItemAsObject(it));
//  cout << "GetDisplayableNode() vtkMRMLNode::SafeDownCast(sceneNodes->GetNextItemAsObject(it)): " << node_test << endl;
...
//      cout << "GetDisplayableNode(): this->GetID(): " << this->GetID() << endl;
//      cout << "GetDisplayableNode(): displayableNode->HasDisplayNodeID(this->GetID()) " << displayableNode->HasDisplayNodeID(this->GetID()) << endl;
//      && displayableNode->HasDisplayNodeID(this->GetID())
        if (displayableNode) {
